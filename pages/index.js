...
export default function Home() {
  ...
  useEffect(() => {
    ...
    // Écoute de l'événement de chargement de la page
  ...
  }, []); // La dépendance vide signifie que ce hook s'exécutera une seule fois après le premier rendu
  ...
  return (
    ...
    {pageLoaded && (<>
      ...
      <main className='container mx-auto'>
        {/* Afficher le contenu seulement après le chargement complet de la page */}
        {pageLoaded && (
          <div>
